...
# Set this to true to automatically shut down containers at the end
AUTO_SHUTDOWN=true

echo -e "${BLUE}=== GoScry Docker Test Script (Automated) ===${NC}"
...
# Auto shutdown based on the setting
if [ "$AUTO_SHUTDOWN" = true ]; then
    echo -e "\n${BLUE}Automatically shutting down containers...${NC}"
    docker compose down
    ...
    echo -e "To shut down later, run: docker compose down"
fi
